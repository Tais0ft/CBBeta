...
const User			=		mongo.model("DRShop", new mongo.Schema({
	id: Number,
	balance: Number,
	ref: Number,
	idref: Number,
...
const Payment			=		mongo.model("DRSPayment", new mongo.Schema({
id: {
		type: Number,
		required: true,
	},
...
const Gift		=		mongo.model("DRSGift", new mongo.Schema({
	id: String,
	uid: Number, 
	crypto: String,
	amount: Number
...
const Curse			=		mongo.model("DRSRate", new mongo.Schema({
	uid: String,
...
const Invests			=		mongo.model("DRSInvest", new mongo.Schema({
	id: Number,
	balance: Number,
	zarabotok: Number,
}));

const Stats			=		mongo.model("DRSStats", new mongo.Schema({
	id: String,
	inv: Number,
	viv: Number,
	suminv: Number,
...
const Ticket		=		mongo.model("DRSTicket", new mongo.Schema({
	owner: Number,
	wallet: String,
	amount: Number
}));

const Ban			=		mongo.model("DRSBan", new mongo.Schema({
	id: Number
}));
